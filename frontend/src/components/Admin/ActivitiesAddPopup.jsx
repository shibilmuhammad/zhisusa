					...
					<div className="w-8/12">
						<div className="w-full flex border-gray-400 border-[.1px] rounded-lg justify-between">
							<input
								...
								class="p-2"
							/>
							<button type="button" onClick={() => addPackage(packageInput.current.value.trim())} className="bg-PrimaryBlue-normal px-4 text-white rounded-r-lg">
								Add
							</button>
							{errMsg.title && (
								<span class=" text-[10px] text-red-600 space-y-0">
						...
						<div className="flex flex-wrap">
							{formData.packages?.map((item,index) => <PackageInputCard index={index} text={item} removePackage={removePackage} />)}

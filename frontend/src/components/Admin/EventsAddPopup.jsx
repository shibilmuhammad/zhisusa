...
import AmenitiesAdder from "./AmenitiesAdder";
import { useSelector,useDispatch } from "react-redux";
import { deleteItemsWithEmptyTitle, deletePackagesWithEmptyTitle, resetPackages } from "../../utils/amenitiesAdminSlice";
const EventsAddPopup = ({ setShowAdd, setLoadData, loadData }) => {
	const dispatch = useDispatch()
	const navigate = useNavigate();
	let amenities = []
	const amenitiesList = useSelector((state) => state?.amenitiesAdmin?.packages)
	...
	const handleSubmit = async (e) => {
		e.preventDefault();
		dispatch(deleteItemsWithEmptyTitle())
		dispatch(deletePackagesWithEmptyTitle())

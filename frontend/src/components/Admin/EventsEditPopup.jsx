...
import { setPackages } from "../../utils/amenitiesAdminSlice";
import AmenitiesAdder from "./AmenitiesAdder";
const EventsEditPopup = ({
	setShowEdit,
	setLoadData,
	loadData,
	dataList,
	...
	const [formData, setFormData] = useState({
		packages: dataList[rowID]?.details?.eventOptions,
	...
	const handleSubmit = async (e) => {
        ...
        finalFormData.append("amenities", JSON.stringify(packages));
		if (validateForm()) {
			setProgress(true);
			try {
	...
	useEffect(() => {
		if (dataList && dataList[rowID]) {
            ...
            dispatch(setPackages(dataList[rowID]?.details?.packages))
...
export default EventsEditPopup;

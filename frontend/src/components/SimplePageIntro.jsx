...
const SimplePageIntro = ({data}) => {
	return (
		<div className={`  h-[35vh] md:h-[45vh] object-center  z-10  relative`}>
			<img className="h-full w-full object-cover absolute -z-20" src={data?.thumb} alt="" />
			<div className="absolute z-20 flex flex-col gap-5 justify-end h-[35vh] md:h-[45vh] px-6 py-5 md:px-12 md:items-center">
			...
			<div className="absolute inset-0 z-10 md:h-[45vh] h-[35vh] bg-black opacity-60"></div>
		</div>
	);
};
